...
var Camera = (function () {
    ...
    Camera.prototype.getMouseRay = function (fov,mouseX,mouseY) {

        var viewSpaceMouseRay = [
            mouseX * Math.tan(fov / 2.0) * (this.element.width / this.element.height),
            mouseY * Math.tan(fov / 2.0),
            -1.0];


        var inverseViewMatrix = Utilities.invertMatrix([], this.getViewMatrix());
